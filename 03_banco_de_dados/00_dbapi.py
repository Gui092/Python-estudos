...
# atualizar_registro(conexao, cursor, 'Guilherme Comparotto', 'gui@gmail.com', 1)
# atualizar_registro(conexao, cursor, 'Gabriel Comparotto',
#                    'gabriel@gmail.com', 2)

### EXCLUINDO OS DADOS DA TABELA ###
# excluir_registro(conexao, cursor, 1)

### INSERINDO MUITOS DADOS DE UMA VEZ NA TABELA ###
# dados = [
#     ('Guilherme', 'guilherme@gmail.com'),
#     ('Arlindo', 'arlindo@gmail.com'),
#     ('Rita', 'rita@gmail.com'),
#     ('Dindo', 'dindo@gmail.com'),
# ]
# inserir_muitos(conexao, cursor, dados)

### BUSCANDO VÁRIAS LINHAS DA TABELA ###
clientes = listar_clientes(cursor)
for cliente in clientes:
    print(dict(cliente))

### BUSCANDO UMA SÓ LINHA DA TABELA ###
